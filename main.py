...
class Villain(db.Model):
    ...
    def __init__(self, name, description, interests, url):
        self.name = name
...
def get_endpoints():
  endpoints = {
    ...
    "/api/villains/delete": "POST - Deletes one single villain from database",
    "/api/villains/add": "POST - Adds one single villain to the database"
  }
